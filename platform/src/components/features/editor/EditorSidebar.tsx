        ...
        <Dropdown>
          <DropdownTrigger>
            <Button
              ...
              endContent={<Icon icon="material-symbols:arrow-drop-down" width={18} />}
              size="sm"
          ...
          <DropdownMenu aria-label="Slide Templates">
            <DropdownItem key="blank" onPress={addNewSlide}>
              <div className="flex items-center gap-2">
                <Icon icon="material-symbols:add-box-outline" width={18} />
            ...
            <DropdownItem key="more" onPress={() => setShowTemplateModal(true)}>
              <div className="flex items-center gap-2">
