// src/components/features/application/editor/data/sampleSlides.ts
    ...
    content: [
      {
        id: 'content-1',
        type: 'text',
        value: 'Greenhouse gases like carbon dioxide trap heat in our atmosphere',
      },
      {
        id: 'content-2',
        type: 'text',
        value: 'Human activities, particularly burning fossil fuels, increase these gases',
      },
      {
        id: 'content-3',
        type: 'text',
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        id: 'content-2',
        type: 'text',
        value: 'Business as usual: 3-4°C warming with catastrophic consequences',
      },
      {
        id: 'content-3',
        type: 'text',
