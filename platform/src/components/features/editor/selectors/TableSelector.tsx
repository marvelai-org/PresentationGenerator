...
export default function TableSelector({ isOpen, onClose, onSelect }: TableSelectorProps) {
          ...
          >
            <div className="bg-content2 h-28 rounded-md flex items-center justify-center mb-3">
              ...
              <div className="w-4/5 h-4/5 bg-content3 rounded flex flex-col">
                {Array.from({ length: Math.min(4, template.rows) }).map((_, rowIndex) => (
  ...
  const renderCustomTab = () => (
    <div className="p-4">
                ...
                <div key={rowIndex} className="flex gap-1">
                  {Array.from({ length: 10 }).map((_, colIndex) => (
                    <div
                      ...
                      onMouseEnter={() => handleTableSizeHover(rowIndex, colIndex)}
                    />
                  ))}
                </div>
              ))}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              id="hasHeaderColumn"
              type="checkbox"
              onChange={e => handleOptionChange('hasHeaderColumn', e.target.checked)}
            />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              id="hasFooter"
              type="checkbox"
              onChange={e => handleOptionChange('hasFooter', e.target.checked)}
            />
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="text-default-600 text-sm block mb-1" htmlFor="borderStyle">
              Style
            </label>
            <select
              ...
              onChange={e => handleOptionChange('borderStyle', e.target.value)}
            >
          ...
          <div className="flex-1">
            <label className="text-default-600 text-sm block mb-1" htmlFor="borderWidth">
              Width
            </label>
            <Input
              classNames={{
              ...
              onChange={e => handleOptionChange('borderWidth', parseInt(e.target.value) || 0)}
            />
          </div>
        </div>
      </div>
          ...
          >
            {customTableOptions.hasHeader && (
              <thead>
                ...
                >
                  {Array.from({ length: customTableOptions.columns }).map((_, index) => (
                    <th
                      key={index}
                      style={{
                        padding: '12px',
            ...
            <tbody>
              {Array.from({
                ...
                >
                  {Array.from({ length: customTableOptions.columns }).map((_, colIndex) => (
                    <td
                      key={colIndex}
                      style={{
                        padding: '12px',
