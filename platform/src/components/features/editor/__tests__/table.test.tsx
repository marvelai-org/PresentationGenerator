...
describe('Table Components', () => {
  describe('TableSelector', () => {
    test('should render table selector modal', () => {
      ...
      render(<TableSelector isOpen={true} onClose={onCloseMock} onSelect={onSelectMock} />);
  ...
  describe('TableProperties', () => {
    test('should render table properties panel', () => {
      ...
      render(<TableProperties tableData={mockTableData} onUpdateTable={onUpdateTableMock} />);
