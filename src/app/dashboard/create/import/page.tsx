    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="p-8 bg-content1/20 rounded-xl">
        ...
        <div className="border-2 border-dashed border-default-200 rounded-xl p-10 flex flex-col items-center justify-center">
          <Icon icon="material-symbols:upload-file" className="w-16 h-16 text-default-400 mb-4" />
          <p className="text-default-600 mb-2">Drag and drop a file here, or click to browse</p>
          <p className="text-default-400 text-sm mb-6">Supports PDF, PPTX, DOCX, TXT (max 10MB)</p>
          
          <Button color="primary" startContent={<Icon icon="material-symbols:upload" />}>
            Choose File
          </Button>
        </div>
