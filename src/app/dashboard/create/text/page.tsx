    ...
    <div className="max-w-4xl mx-auto py-6">
      ...
      <div className="flex flex-col items-center text-center mb-10 animate-fadeIn">
        <div className="flex items-center mb-4">
          <div className="bg-primary/10 p-3 rounded-xl transition-all hover:bg-primary/20">
            <Icon className="text-primary w-8 h-8" icon="material-symbols:description" />
          </div>
          <h2 className="text-3xl font-bold ml-3 bg-gradient-to-r from-primary-500 to-indigo-500 bg-clip-text text-transparent">
            Create from Text
          </h2>
        </div>
        <p className="text-default-500 text-lg">Paste your text, notes, or outline below</p>
      </div>
      ...
      >
        <Textarea
          ...
          classNames={{
            base: 'rounded-xl',
            inputWrapper: 'bg-transparent shadow-none border-0 hover:border-0 focus:border-0',
