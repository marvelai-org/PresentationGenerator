...
import { Button, Card, Dropdown, DropdownItem, DropdownMenu, DropdownTrigger, Input, Tabs, Tab, Tooltip, ButtonGroup } from "@heroui/react";
  ...
  return (
    <div className="max-w-5xl mx-auto pb-32">
        ...
        <Card className="bg-content1/20 p-4">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-lg">Collaborating with other creators on a joint project or collaboration</p>
            </div>
      ...
      <div className="space-y-4 mb-8">
        {slides.map((slide) => (
          <Card key={slide.id} className="bg-content1/10 border border-content2">
            <div className="flex p-4">
              ...
              <div>
                {slide.id === 6 && (
                  <Button isIconOnly variant="light" className="text-default-500" onPress={() => deleteSlide(slide.id)}>
      ...
      <div className="mb-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2">
            ...
            <Button variant="light" size="sm" startContent={<Icon icon="material-symbols:visibility" />}>
              View more
            </Button>
          </div>
          <p className="text-default-500 text-sm mb-4">Use one of our popular themes below or view more</p>
            ...
            <div className="relative">
              <Card className="p-4 border-2 border-primary">
                <div className="p-2 rounded-lg bg-[#FFF9C4] mb-2">
                  ...
                  <div className="text-sm">Body & <span className="text-blue-500">link</span></div>
                </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <Card className="p-4">
              <div className="p-2 rounded-lg bg-black mb-2">
                ...
                <div className="text-sm text-white">Body & <span className="text-yellow-400">link</span></div>
              </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-default-500 text-sm mb-4">Adjust text and image styles for your gamma</p>
          ...
          <div className="mb-6">
            ...
            <ButtonGroup variant="flat" className="w-full">
              <Button 
                className={textDensity === "Brief" ? "bg-primary text-white flex-1" : "flex-1"}
              ...
              <Button 
                className={textDensity === "Medium" ? "bg-primary text-white flex-1" : "flex-1"}
              ...
              <Button 
                className={textDensity === "Detailed" ? "bg-primary text-white flex-1" : "flex-1"}
            ...
            <Dropdown>
              <DropdownTrigger>
                <Button 
                  ...
                  endContent={<Icon icon={showImageOptions ? "material-symbols:keyboard-arrow-up" : "material-symbols:keyboard-arrow-down"} />}
              ...
              >
                <DropdownItem key="Automatic" startContent={<Icon icon="material-symbols:auto-awesome" />}>
                  <div>
                    <div>Automatic</div>
                    <div className="text-xs text-default-500">Automatically select best image type for each image</div>
                  </div>
                </DropdownItem>
                <DropdownItem key="Stock photos" startContent={<Icon icon="material-symbols:image" />}>
                  <div>
                    <div>Stock photos</div>
                    <div className="text-xs text-default-500">Search free high-resolution photos and backgrounds from Unsplash</div>
                  </div>
                </DropdownItem>
                <DropdownItem key="Web images" startContent={<Icon icon="material-symbols:public" />}>
                  <div>
                    <div>Web images</div>
                    <div className="text-xs text-default-500">Search the internet for images</div>
                  </div>
                </DropdownItem>
                <DropdownItem key="AI images" startContent={<Icon icon="material-symbols:auto-awesome" />}>
                  <div>
                    <div>AI images</div>
                    <div className="text-xs text-default-500">Generate original images and graphics with AI</div>
                  </div>
                </DropdownItem>
                <DropdownItem key="Illustrations" startContent={<Icon icon="material-symbols:draw" />}>
                  <div>
                    <div>Illustrations</div>
                    <div className="text-xs text-default-500">Search for illustrations from Pictographic</div>
                  </div>
                </DropdownItem>
                <DropdownItem key="Animated GIFs" startContent={<Icon icon="material-symbols:gif-box" />}>
                  <div>
                    <div>Animated GIFs</div>
                    <div className="text-xs text-default-500">Search for fun animated GIFs from Giphy</div>
                  </div>
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
            ...
            <Dropdown>
              <DropdownTrigger>
                <Button 
                  ...
                  endContent={<Icon icon="material-symbols:keyboard-arrow-down" />}
                >
                  {aiModel}
                </Button>
              </DropdownTrigger>
              ...
              >
                <DropdownItem textValue="Basic models header" className="text-sm opacity-70">
                  Basic models
                </DropdownItem>
                <DropdownItem key="Flux Fast" startContent={<Icon icon="material-symbols:bolt" />}>
                  <div className="flex justify-between w-full">
                    <span>Flux Fast</span>
                    <span className="text-xs text-default-500">Black Forest Labs</span>
                  </div>
                </DropdownItem>
                <DropdownItem key="Imagen 3 Fast" startContent={<Icon icon="material-symbols:star" />}>
                  <div className="flex justify-between w-full">
                    <span>Imagen 3 Fast</span>
                    <span className="text-xs text-default-500">Google</span>
                  </div>
                </DropdownItem>
                <DropdownItem textValue="Advanced models header" className="text-sm opacity-70">
                  <div className="flex items-center">
                    Advanced models
                    <span className="ml-2 bg-primary text-xs text-white px-1 rounded">PLUS</span>
                  </div>
                </DropdownItem>
                <DropdownItem key="Flux Pro" startContent={<Icon icon="material-symbols:bolt" />}>
                  <div className="flex justify-between w-full">
                    <span>Flux Pro</span>
                    <span className="text-xs text-default-500">Black Forest Labs</span>
                  </div>
                </DropdownItem>
                <DropdownItem key="Ideogram 2 Turbo" startContent={<Icon icon="material-symbols:star" />}>
                  <div className="flex justify-between w-full">
                    <span>Ideogram 2 Turbo</span>
                    <span className="text-xs text-default-500">Ideogram</span>
                  </div>
                </DropdownItem>
                <DropdownItem key="Imagen 3" startContent={<Icon icon="material-symbols:star" />}>
                  <div className="flex justify-between w-full">
                    <span>Imagen 3</span>
                    <span className="text-xs text-default-500">Google</span>
                  </div>
                </DropdownItem>
                <DropdownItem key="Leonardo Phoenix" startContent={<Icon icon="material-symbols:star" />}>
                  <div className="flex justify-between w-full">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-background z-10">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <div className="flex items-center text-default-500">
            <Icon icon="material-symbols:toll" className="mr-2" />
