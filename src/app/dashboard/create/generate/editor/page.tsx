  ...
  return (
    <div ref={editorRef} className="flex flex-col h-screen bg-black overflow-hidden">
      ...
      <div className="flex items-center p-2 bg-black border-b border-gray-800">
        <Button 
          as={Link}
          href="/dashboard/create/generate/outline"
          variant="light" 
          isIconOnly
          ...
          <div className="w-48 bg-black border-r border-gray-800 overflow-y-auto flex-shrink-0">
            <div className="p-2 space-y-2">
              {slides.map((slide, index) => (
                <div 
                  key={slide.id}
                  className={`rounded overflow-hidden cursor-pointer relative ${currentSlideIndex === index ? 'ring-2 ring-indigo-600' : ''}`}
                ...
                >
                  ...
                  <div className="h-24 bg-[#1a0e2e] p-2 text-center flex flex-col justify-center">
                    {index === 0 ? (
                      <>
                        <div className="text-[#ff758c] text-xs font-bold">Can We REALLY Stop Climate Change?</div>
                        <div className="text-white text-[8px] mt-1">The future of our planet is at stake...</div>
                      </>
                    ) : (
                      <>
        ...
        <div className="flex-1 bg-[#191919] overflow-auto relative">
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center gap-2 bg-black/60 rounded-full px-4 py-1">
            ...
            <Button 
              ...
              onPress={() => navigateToSlide(Math.min(slides.length - 1, currentSlideIndex + 1))}
            >
          ...
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex flex-col gap-4 bg-black/30 p-1 rounded-lg">
            ...
            <Tooltip content="Fullscreen" placement="left">
              ...
              >
                <Icon icon={isFullscreen ? "material-symbols:fullscreen-exit" : "material-symbols:fullscreen"} width={20} />
              </Button>
            </Tooltip>
