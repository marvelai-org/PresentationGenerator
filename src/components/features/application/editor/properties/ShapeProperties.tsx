...
export default function ShapeProperties({
  ...
  const handleNumberPropertyChange = (
    property: keyof ShapeContentItem,
    value: number,
  ) => {
    onUpdateShape(selectedShape.id, {
      [property]: value,
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <div
                ...
                style={{
                  backgroundColor:
                    selectedShape.style?.backgroundColor || "transparent",
                }}
              />
              <Input
                className="flex-1"
          ...
          <div>
            ...
            <div id="borderStyle" className="flex gap-2">
              <Button
                ...
                size="sm"
                variant={
                  selectedShape.style?.borderStyle === "none" ? "solid" : "flat"
                }
              ...
              <Button
                className={
                  selectedShape.style?.borderStyle === "dashed"
                    ? "bg-indigo-600"
                    : ""
                }
                color={
              ...
              <Button
                className={
                  selectedShape.style?.borderStyle === "dotted"
                    ? "bg-indigo-600"
                    : ""
                }
                color={
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{
                      backgroundColor:
                        selectedShape.style?.borderColor || "transparent",
                    }}
                  />
                  <Input
                    id="borderColor"
            ...
            selectedShape.style.borderStyle !== "none" && (
              <div>
                ...
                <Slider
                  ...
                  onChange={(value) =>
                    handleStylePropertyChange("borderWidth", value)
                  }
                />
              </div>
            )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                onChange={(value) =>
                  handleNumberPropertyChange("width", value as number)
                }
              />
              <Input
                className="w-20"
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                onChange={(value) =>
                  handleNumberPropertyChange("height", value as number)
                }
              />
              <Input
                className="w-20"
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                onChange={(value) =>
                  handleStylePropertyChange("rotation", value)
                }
              />
              <Input
                className="w-20"
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              size="sm"
              startContent={
                <Icon icon="material-symbols:fit-screen" width={16} />
              }
              variant="flat"
            >
              Fit to Content
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                onChange={(value) =>
                  handleNumberPropertyChange("x", value as number)
                }
              />
              <Input
                className="w-20"
                ...
                onChange={(e) =>
                  handleNumberPropertyChange("x", parseInt(e.target.value) || 0)
                }
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                onChange={(value) =>
                  handleNumberPropertyChange("y", value as number)
                }
              />
              <Input
                className="w-20"
                ...
                onChange={(e) =>
                  handleNumberPropertyChange("y", parseInt(e.target.value) || 0)
                }
              />
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                onPress={() =>
                  handleStylePropertyChange(
                    "zIndex",
                    (selectedShape.style?.zIndex || 1) - 1,
                  )
                }
              >
                Send Backward
