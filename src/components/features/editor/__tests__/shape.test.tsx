...
describe('Shape Components', () => {
  describe('ShapeSelector', () => {
    ...
    test('should render shape selector modal', () => {
      render(<ShapeSelector isOpen={true} onClose={mockOnClose} onSelect={mockOnSelect} />);
    ...
    test('should select a shape', () => {
      ...
      expect(mockOnSelect).toHaveBeenCalledWith(expect.stringContaining('square'));
  ...
  describe('ShapeProperties', () => {
    test('should render properties panel', () => {
      render(<ShapeProperties selectedShape={mockShape} onUpdateShape={mockOnUpdateShape} />);
    ...
    test('should update shape properties', () => {
      ...
      const xInput =
        screen.getByLabelText(/x position/i) || screen.getByRole('spinbutton', { name: /x/i });
    ...
    test('should update shape style', () => {
      ...
      const colorInput = screen.getByLabelText(/fill color/i) || screen.getAllByRole('textbox')[0];
    ...
    test('should update rotation', () => {
      ...
      const rotationInput =
        screen.getByLabelText(/rotation/i) || screen.getByRole('spinbutton', { name: /rotation/i });
  ...
  describe('Integration', () => {
    test('should handle the complete shape workflow', () => {
      ...
      const { unmount } = render(
        <ShapeSelector isOpen={true} onClose={mockOnClose} onSelect={mockOnSelect} />
      );
